...
//---- Render komponen menu Manajemen Akun ----//
  ...
  return (
    <div className="manajemen-akun-container" style={{ padding: 0, background: '#f5f5f5', minHeight: '100vh' }}>
      {/* Top Bar ala admin-dashboard */}
      ...
      {/* Konten utama tetap seperti sebelumnya */}
