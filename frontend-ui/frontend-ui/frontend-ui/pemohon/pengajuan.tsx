...
export default function PengajuanForm() {
    // Ambil nama user dari localStorage (userData)
      ...
      if (typeof window !== 'undefined') {
        try {
          ...
          if (userData) {
            ...
            setUserName(user?.nama || user?.name || "-");
          }
        } catch {}
      }
    }, []);
  ...
  <div className="pemohon-home">
    <header className="ph-topbar">
      <div style={{ display: 'flex', alignItems: 'center' }}>
        {/* Perbaikan: Menggunakan userName yang sudah ada di state */}
        <div className="brand" style={{ fontSize: "24px", fontWeight: "bold" }}>{userName}</div>
        <div className="logos">
